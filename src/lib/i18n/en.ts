...
const en: Record<string, string> = {
  ...
  'manager.plagiarismMaxCandidates': 'Max result pairs',
  'manager.plagiarismAcceptedOnly': 'Accepted only',
  'manager.plagiarismHint': 'The system performs local heuristic similarity screening. Pairs exceeding the threshold are returned as suspicious. The final cheating decision is made by the teacher.',
  ...
  'manager.plagiarismHeuristicScore': 'Similarity',
