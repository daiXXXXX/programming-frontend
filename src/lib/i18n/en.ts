...
const en: Record<string, string> = {
  ...
  'problemDetail.localTest': 'Run Samples',
  'problemDetail.localTesting': 'Testing...',
  'problemDetail.localTestResults': 'Sample Test Results',
  'problemDetail.localTestHint': 'Sample testing runs only public examples and does not create a submission record.',
  ...
  'problemDetail.errorMessage': 'Error Message',
  'problemDetail.executionTime': 'Execution Time',
  'problemDetail.noTestResults': 'No test results yet',
  ...
  'manager.plagiarismTitle': 'Code Plagiarism Review',
  'manager.plagiarismProblem': 'Problem',
  'manager.plagiarismPickProblem': 'Please choose a problem first',
  'manager.plagiarismMaxCandidates': 'AI candidate cap',
  'manager.plagiarismThreshold': 'Heuristic threshold',
  'manager.plagiarismAcceptedOnly': 'Accepted only',
  'manager.plagiarismHint': 'The teacher must click manually to trigger AI review. The system only returns suspicious pairs; the final cheating decision is still made by the teacher.',
  'manager.plagiarismRun': 'Run plagiarism check',
  'manager.plagiarismRunSuccess': 'Plagiarism check completed',
  'manager.plagiarismRunFailed': 'Plagiarism check failed',
  'manager.plagiarismNoProblems': 'No problems are available for plagiarism review in this class',
  'manager.plagiarismComparedStudents': 'Compared students',
  'manager.plagiarismCandidatePairs': 'Candidate pairs',
  'manager.plagiarismResultCount': 'Suspicious pairs',
  'manager.plagiarismNoCandidates': 'No suspicious pairs need manual review this time',
  'manager.plagiarismHeuristicScore': 'Heuristic score',
  'manager.plagiarismAIConfidence': 'AI confidence',
  'manager.plagiarismViewSubmissionA': 'View submission A',
  'manager.plagiarismViewSubmissionB': 'View submission B',
  'manager.plagiarismMarkCheating': 'Mark as cheating',
  'manager.plagiarismAlreadyMarked': 'Already marked',
  'manager.plagiarismConfirmTitle': 'Confirm marking this pair as cheating?',
  'manager.plagiarismConfirmContent': 'Once confirmed, both submissions will receive the “作弊” tag. Use this only after manual instructor review.',
  'manager.plagiarismMarkSuccess': 'Both submissions have been tagged as cheating',
  'manager.plagiarismMarkFailed': 'Failed to mark cheating',
  'manager.plagiarismSubmissionId': 'Submission ID',
  'manager.plagiarismLanguage': 'Language',
  'manager.plagiarismStatus': 'Status',
  'manager.plagiarismSelection': 'Selection',
  'manager.plagiarismSubmittedAt': 'Submitted at',
  'manager.plagiarismNoTags': 'No tags',
  'manager.plagiarismEvidence': 'Suspicious evidence',
  'manager.plagiarismDifferences': 'Distinguishing points',
  'manager.selectionLatestAccepted': 'Latest accepted submission',
  'manager.selectionLatestSubmission': 'Latest submission',
  'manager.selectionManualReview': 'Manual review submission',
  ...
  'profile.classInfo': 'Class',
  'profile.classInfoPlaceholder': 'Current class',
  'profile.classUnassigned': 'Not assigned to a class yet',
  'profile.bio': 'Bio',
